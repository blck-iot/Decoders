/**
 * ChirpStack v3/v4 payload decoder for GlobalSat LT-501 Series GPS Tracker
 * @author       BLCK-IoT.com
 * @license      MIT
 * @version      1.0.0
 * @param  {number}     fPort
 ...
 *
 * ── Notes ─────────────────────────────────────────────────────────────────────
 *   Default FPort: 2 (AT param D7) -- also field-confirmed AT-configured to
 *   FPort 3 across a real deployed fleet (2026-09-25). Decoding here keys off
 *   byte[0]/command ID only, never FPort, so any AT-configured FPort decodes
 *   identically.
