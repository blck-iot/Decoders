/**
 * Actility (ThingPark) payload decoder for SW3L - Flow Sensor
 * @author       BLCK-IoT.com
 * @license      MIT
 * @version      1.0.0
 * @param  {number}     fPort
...
function _vendorDecodeUplink(input) {
  ...
  switch (input.fPort) {
    ...
    case 5:
      {
        // 0x1F confirmed via two independent Dragino manual fetches ("Sensor Model:
        // For SW3L-LB/LS, this value is 0x1F"); no evidence anywhere of a distinct
        // bare "SW3L" variant using 0x11 -- treated as a genuine bug, not a variant.
        if (bytes[0] == 0x1F) data.SENSOR_MODEL = 'SW3L';
