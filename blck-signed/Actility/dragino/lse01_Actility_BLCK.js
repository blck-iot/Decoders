/**
 * Actility (ThingPark) payload decoder for LSE01 - Soil Moisture & EC Sensor
 * @author       BLCK-IoT.com
 * @license      MIT
 * @version      1.0.0
 * @param  {number}     fPort
  ...
  switch (input.fPort) {
    case 2:
      ...
      if ((value & 0x8000) >> 15 === 0)
        ...
        // fixed in LLMS01/LSPH01 -- 0xffff = 65535, not 65536).
        data.temp_SOIL = ((value - 65536) / 100).toFixed(2); //temp_SOIL,temperature,units:°C
