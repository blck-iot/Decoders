/**
 * Actility (ThingPark) payload decoder for LLMS01 - Leaf Moisture Sensor
 * @author       BLCK-IoT.com
 * @license      MIT
 * @version      1.0.0
 * @param  {number}     fPort
  ...
  switch (input.fPort) {
    case 2:
      ...
      if ((value & 0x8000) >> 15 === 0)
        ...
        // BLCK correction (2026-08-14, confirmed against docs.dragino.com's LLMS01
        // page worked example FF3FH -> -19.3 deg): 0xffff = 65535, not 65536 --
        // off-by-one caused every negative Leaf_Temperature reading to read 0.1C
        // too high (e.g. true -19.3C computed as -19.2C).
        temp = ((value - 65536) / 10).toFixed(2);
