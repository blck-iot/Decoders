/**
 * Actility (ThingPark) payload decoder for LSPH01 - Soil pH Sensor
 * @author       BLCK-IoT.com
 * @license      MIT
 * @version      1.0.0
 * @param  {number}     fPort
  ...
  switch (input.fPort) {
    case 2:
      ...
      if ((value & 0x8000) >> 15 === 0) temp = (value / 10).toFixed(2);
        ...
        // BLCK correction (2026-08-14, same off-by-one pattern confirmed and
        // fixed in LLMS01 -- 0xffff = 65535, not 65536): fixes a 0.1C error on
        // every negative TEMP_SOIL reading.
